...
namespace seq2seq {
    class GlobalAssets {
        public:
            ...
            inline cublasHandle_t& cublasHandle() {return _cublasHandle;}

            inline cudnnHandle_t& cudnnHandle() {return _cudnnHandle;}
            ~GlobalAssets(){std::cerr<<"delete GlobalAssets"<<std::endl;}
